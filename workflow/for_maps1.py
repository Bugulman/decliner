...
def for_maps1 (variables = for_maps1_variables):
    ...
    grid_property_calculator (mesh=find_object (name="Results (SHORT_AREA: UNGKM_13_big)",
    ...
    for obj in range(0,len(objects)):
        ...
        if obj in [0,2,4,6]:
            ...
            map_2d_create_by_grid_property (grid=find_object (name="Results (SHORT_AREA: UNGKM_13_big)",
                  type="gt_tnav_grid_3d_data"),
                  use_user_cut=True,
                  ...
                  variables=variables),
                  type="Map2d"), "zone_id" : 0, "method" : "average", "smooth" : True, "blocked_wells" : None}, {"use" : False, "cube" : find_object (name="PS5-plus",
                  ...
                  variables=variables),
                  type="Map2d"), "zone_id" : 0, "method" : "average", "smooth" : True, "blocked_wells" : None}, {"use" : True, "cube" : find_object (name="CALC_PRESSURE",
                  type="gt_tnav_cube_3d_data"), "map_2d" : find_object (name=resolve_variables_in_string (string_with_variables="@PRESS@",
                  variables=variables),
                  type="Map2d"), "zone_id" : 0, "method" : "average", "smooth" : True, "blocked_wells" : None}, {"use" : True, "cube" : find_object (name="ARRXXXARRCYLINDER",
                  type="gt_tnav_cube_3d_data"), "map_2d" : find_object (name=resolve_variables_in_string (string_with_variables="@PERM_MULT@",
                  variables=variables),
    ...
    if False:
        begin_wf_item (index = 21, is_custom_code = True, name = "выгрузка карт в папку")
