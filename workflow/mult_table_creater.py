...
""")
    ...
    if False:
        ...
        object_template_mapping (action="replace",
              folder=find_object (name="3D-Grids",
              type="TypedFolder"),
              use_grid=True,
    ...
    wells_log_create_by_grid_property (mesh=find_object (name="BLACK_OIL_DEMO",
          type="Grid3d"),
          ...
          type="Trajectories"),
          use_well_filter=False,
          well_filter=find_object (name=resolve_variables_in_string (string_with_variables="@AVG_LOG@",
          variables=variables),
          type="WellFilter"))
    end_wf_item (index = 7)
...
""")
    ...
    if False:
        ...
        marker_calculator (result_well_marker=find_object (name="MULT_ZONE_3",
              type="WellMarker"),
              use_well_filter=False,
              well_filter=find_object (name="Import Model Well Filter(BLACK_OIL_DEMO)",
              type="WellFilter"),
